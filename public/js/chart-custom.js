...
//  top genre chart
if (document.querySelector('#genre-chart')) {
    ...
    const options = {
        ...
        colors: colors,
        labels: ['فيلم طويل', 'فيلم قصير', 'عرض واقعي', 'وثائقي قصير', 'إنتاج طلابي'],
        dataLabels: {
            enabled: false,
        },
        legend: {
    ...
    var chart = new ApexCharts(document.querySelector("#genre-chart"), options);
    chart.render();
}


if (document.querySelector('#total-revenue-subscription')) {
    var options = {
        series: [{
            name: 'طلب ',
 ...
 "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"
    ...
    var chart = new ApexCharts(document.querySelector("#total-revenue-subscription"), options);
    chart.render();
}

if (jQuery("#new-subcriber").length) {
    const colors = ['var(--bs-primary)', 'var(--bs-primary-tint-20)', 'var(--bs-primary-tint-40)', 'var(--bs-primary-tint-60)'];
    var options = {
        series: [{
            name: 'سينما',
 ...
 "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"]
    ...
    var chart = new ApexCharts(document.querySelector("#new-subcriber"), options);
    chart.render();
}

if (document.querySelector('#d-activity')) {
    const colors = ['var(--bs-primary)', 'var(--bs-primary-tint-20)', 'var(--bs-primary-tint-40)', 'var(--bs-primary-tint-60)']; // Default colors for bars
...
if (document.querySelector('#top-rated-chart')) {
    const colors = ['var(--bs-primary)', 'var(--bs-primary-tint-40)'];
    ...
    const chart = new ApexCharts(document.querySelector("#top-rated-chart"), options);
    chart.render();
}
