<div class="card">
    ...
    <div class="card-body">
        <div class="border rounded p-3 bg-light mb-4">
            <form method="POST" action="{{ route('admin.scouting-requests.correspondence.store', $requestRecord) }}" enctype="multipart/form-data" class="row g-3">
                @csrf
                <div class="col-md-4">
                    ...
                    <div class="border rounded p-3">
                        <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap">
                            ...
                            @if ($message->attachment_path)
                                <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.scouting-requests.correspondence.download', [$requestRecord, $message]) }}">{{ __('app.correspondence.download_attachment') }}</a>
                            @endif
                        </div>
