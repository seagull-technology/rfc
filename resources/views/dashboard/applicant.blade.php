...
@extends('layouts.portal-dashboard', ['title' => __('app.dashboard.applicant_title')])
...
@push('styles')
    <style>
        ...
        .portal-applicant-hero .card-body {
            padding: 2.5rem 1rem 2rem;
        }

        .portal-applicant-hero .avatar-130 {
            height: 130px;
            width: 130px;
        }

        .portal-applicant-hero h3 {
            font-size: 2.25rem;
            font-weight: 700;
            margin-bottom: 0;
        }
        ...
        .applicant-dashboard-layout > .row {
            margin-bottom: 0;
        }

        .applicant-dashboard-layout > .row:first-child {
            margin-top: 0;
        }

        .applicant-dashboard-layout .card {
            margin-bottom: 1.5rem;
        }

        .applicant-dashboard-layout .dashboard-metric-card .card-body {
            min-height: 205px;
        }

        .applicant-dashboard-layout .dashboard-scout-card .card-body {
            min-height: 132px;
            display: flex;
            align-items: center;
        }

        .applicant-dashboard-layout .card-header {
            padding-bottom: 0;
        }

        .applicant-dashboard-layout .card-dashboard .card-header {
            padding-top: 1.5rem;
        }

        .applicant-dashboard-layout .card-dashboard .card-header .btn-danger {
            min-height: 44px;
            padding: .75rem 1.25rem;
        }

        .applicant-dashboard-layout .table-responsive.rounded.py-4 {
        ...
        .applicant-dashboard-layout .dashboard-scout-card img {
            width: 64px;
            height: 64px;
            object-fit: contain;
        }

        .applicant-dashboard-layout .dashboard-scout-card {
            border-radius: .5rem;
        }
...
@section('hero')
    <div class="card bg-image-12 portal-applicant-hero">
        <div class="card-body">
