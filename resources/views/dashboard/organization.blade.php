...
@push('styles')
    <style>
        ...
        .organization-dashboard-layout .portal-request-table-scroll {
            max-width: 100%;
            overflow-x: auto;
            overflow-y: hidden;
        }

        .organization-dashboard-layout .portal-request-table {
            min-width: 980px;
            table-layout: fixed;
            width: 100%;
        }

        .organization-dashboard-layout .portal-request-table thead th,
        .organization-dashboard-layout .portal-request-table tbody td {
            white-space: normal;
            vertical-align: top;
            word-break: break-word;
        }

        .organization-dashboard-layout .portal-request-table thead th:first-child,
        .organization-dashboard-layout .portal-request-table tbody td:first-child,
        .organization-dashboard-layout .portal-request-actions-cell {
            text-align: center;
        }

        .organization-dashboard-layout .portal-request-actions-cell .list-user-action {
                ...
                <div class="card-body pt-0">
                    <div class="mt-4 table-responsive">
                        <div class="table-responsive rounded py-4 portal-request-table-scroll">
                            <table id="organization-production-table" class="table portal-request-table" data-toggle="data-table">
                                <colgroup>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card card-dashboard">
                ...
                <div class="card-body pt-0">
                    <div class="mt-4 table-responsive">
                        <div class="table-responsive rounded py-4 portal-request-table-scroll">
                            <table id="organization-scouting-table" class="table portal-request-table" data-toggle="data-table">
                                <colgroup>
                                    <col style="width: 64px">
                                    <col style="width: 150px">
                                    <col style="width: 270px">
