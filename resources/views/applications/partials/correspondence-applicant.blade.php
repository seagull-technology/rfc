    ...
    <div class="card-body">
                    ...
                    <div class="border rounded p-3">
                        <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap">
                            ...
                            @if ($message->attachment_path)
                                <a class="btn btn-sm btn-outline-primary" href="{{ route('applications.correspondence.download', [$application, $message]) }}">{{ __('app.correspondence.download_attachment') }}</a>
                            @endif
                        </div>
        ...
        <div class="comment-area pt-3">
            ...
            <div class="border rounded p-3 bg-light">
                <form method="POST" action="{{ route('applications.correspondence.store', $application) }}" enctype="multipart/form-data" class="row g-3">
                    @csrf
                    <div class="col-lg-4">
