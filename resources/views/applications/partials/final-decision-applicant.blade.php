    ...
    <div class="card-body">
        @if ($application->finalDecisionIssued())
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                @endif
                <a class="btn btn-outline-secondary" href="{{ route('applications.final-letter.print', $application) }}" target="_blank" rel="noopener">{{ __('app.final_decision.print_letter') }}</a>
            </div>
        @else
