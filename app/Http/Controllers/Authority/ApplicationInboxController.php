...
class ApplicationInboxController extends Controller
{
    ...
    private function annexSectionsForRoutingFlag(string $flag): array
    {
        return match ($flag) {
            ...
            'imported_equipment' => ['equipment_travelers', 'imported_equipment'],
            'public_security_support' => ['filming_locations', 'public_security_support'],
            'military_support' => ['filming_locations', 'military_support'],
    ...
    private function filledAnnexSections(FilmApplication $application): array
    {
        ...
        return collect([
            ...
            'imported_equipment' => $this->annexRowsHaveData(data_get($annex, 'imported_equipment', [])) || $this->annexRowsHaveData(data_get($annex, 'equipment_travelers', [])),
            'public_security_support' => $this->annexRowsHaveData(data_get($annex, 'public_security_support', [])),
            'military_support' => $this->annexRowsHaveData(data_get($annex, 'military_support', [])),
